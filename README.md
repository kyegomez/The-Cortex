...
2. Regularly review AI research papers and repositories from sources like [arXiv](https://arxiv.org/), [NeurIPS](https://neurips.cc/), [ICLR](https://iclr.cc/), and [GitHub](https://github.com/), [AK](https://twitter.com/_akhaliq)
3. Attend AI conferences, webinars, and workshops to stay updated on the latest developments.
4. Collaborate with researchers, engineers, and domain experts to brainstorm and generate new ideas.
5. Open source your ideas as much as possible

**Resources**: arXiv, NeurIPS, ICLR, GitHub, AI conferences, webinars, workshops, research groups, interdisciplinary collaboration platforms, [https://paperswithcode.com](https://paperswithcode.com/),
...
2. Consider the potential impact on different AI subfields, such as natural language processing, computer vision, reinforcement learning, etc.
3. Evaluate the novelty, feasibility, and relevance of the proposed ideas to the broader AI community.

***List of resources:***

### Agora:

**[Join the Agora Discord Server!***Agora advances Humanity with Multi-Modality AI Research | 142 members*discord.gg](https://discord.gg/sbYvXgqc)
...
- [Miro](https://miro.com/): A collaborative online whiteboard platform for brainstorming and discussing research implications.
- [Zotero](https://www.zotero.org/): A free, open-source reference management software for organizing and citing research.
...
1. Set up a collaboration platform (e.g., [Jupyter Notebook](https://jupyter.org/), [Google Colab](https://colab.research.google.com/)) to facilitate teamwork and idea exchange.
2. Define clear roles and responsibilities for yourself or team members to streamline the research process.
3. Create a shared repository to store code, data, and other research-related materials.

*List of resources:*

- [Jupyter Notebook](https://jupyter.org/): An open-source web application for creating and sharing live code, equations, visualizations, and narrative text.
- [Google Colab](https://colab.research.google.com/): A cloud-based Jupyter notebook environment that allows for collaborative coding, experimentation, and model training.
- [GitHub](https://github.com/): A web-based platform for version control and collaboration, allowing researchers to share code, track changes, and collaborate on projects.
...
2. Analyze the strengths and weaknesses of existing methods to determine areas for improvement.
3. Document the findings in a systematic manner, with proper citations and references and then open source them on github or a blog.
...
2. Design experiments to test the hypotheses, including data collection, preprocessing, model development, and evaluation.
3. Establish a timeline and milestones for the research project [less than 1 week]

### *List of resources:*

- [arXiv](https://arxiv.org/): A repository of electronic preprints for research papers in various fields, including AI and machine learning.
- [Semantic Scholar](https://www.semanticscholar.org/): An AI-powered research tool for finding relevant academic papers and literature.
- [Google Scholar](https://scholar.google.com/): A search engine for scholarly literature across various disciplines and sources.
...
- [Notion](https://www.notion.so/): An all-in-one workspace for note-taking, project management, and collaboration.
- [Google Colab](https://colab.research.google.com/): A cloud-based Jupyter notebook environment that allows for collaborative coding, experimentation, and model training.
- [PyTorch](https://pytorch.org/): An open-source machine learning library for Python, providing a flexible deep learning development platform.
- [Trello](https://trello.com/): A visual tool for organizing and prioritizing projects and tasks using boards, lists, and cards.
- [Asana](https://asana.com/): A web and mobile application for work management and tracking, allowing teams to organize, plan, and collaborate on projects.
- [Basecamp](https://basecamp.com/): A project management and team collaboration tool that helps manage projects, tasks, and communication.
...
2. Regularly conduct code reviews and debugging sessions to ensure the quality of the research work.
3. Document the experimental setup, results, and findings in detail.
...
2. Configure AWS EC2 instances with the necessary hardware (e.g., GPUs) and software (e.g., TensorFlow, PyTorch) for model training.
3. Implement efficient training pipelines to minimize computational costs and training time.
4. Monitor the training progress, and adjust hyperparameters or model architectures as needed weights and biases and tensorboard
...
2. Compare the results with SOTA methods to assess the significance of the research contribution.
3. Iterate the research process, refining the hypotheses, experiments, and models as needed.
...
2. Share the research findings in conferences, journals, or preprint servers to receive feedback from the AI community.
3. Contribute the developed code and models to open-source repositories to facilitate further research and collaboration.
...
- [Sphinx](https://www.sphinx-doc.org/en/master/): A tool for creating intelligent and beautiful documentation for Python projects.
- [MkDocs](https://www.mkdocs.org/): A static site generator geared towards building project documentation using Markdown.
- [Read the Docs](https://readthedocs.org/): A platform for building, hosting, and sharing documentation for open-source projects.
